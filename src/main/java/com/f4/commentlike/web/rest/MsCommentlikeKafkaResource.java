...
import com.f4.commentlike.kafka.broker.KafkaConsumer;
import com.f4.commentlike.kafka.handler.EventEnvelope;
...
public class MsCommentlikeKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(MsCommentlikeKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public MsCommentlikeKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
